...
//		pays.ad/(new PayVO(instinew PayVO(instid1, d1, instid1, 2000, "transport", 0, 0, 0)d1, d1, instid1, 4000, "salary", 0, 0, 0));
...
//		pays.add();
//		pays.add(new PayVO(innew PayVO(instid1, d1, instid1, 1500,"", 0, 0, 0)stid1, d2, instid1, 3000, "", 0, 0, 0));
		return pays;
	}
