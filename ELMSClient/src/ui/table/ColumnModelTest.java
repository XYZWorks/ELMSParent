 ...
 * getRowCount(),getValueAt()方法.因此我们可以通*过MyTable来产生TableModel的实体.*/
 ...
 * ,再由 TableColumnModel类所提供的getColumn()方*法取得TableColumn对象,
 * TableColumn类可针对表格中的每一 行做具体的设置,例如设置字段的宽度,某行的标头,
 * 设置输入较复杂的*数据类型等等.在这里,我们利用TableColumn类所提供的 setCellEditor()方法,
 * 将JComboBox作为第二行的默认编辑组件.*/
