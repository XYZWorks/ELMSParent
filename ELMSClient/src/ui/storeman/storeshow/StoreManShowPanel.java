...
public class StoreManShowPanel extends MyPanel {
	...
	public StoreManShowPanel(Element config, StoreController bl,
			StoreManController controller) {
		super(config);
		this.bl = bl;
	...
	protected void addListener() {
		confirmButton.addMouseListener(new SingleShowListener(confirmButton,
				"StoreManSingleShowPanel", controller));
		returnButton.addMouseListener(new MyJumpListener(returnButton,
				StaticMessage.MAIN_WINDOW, controller, false));
