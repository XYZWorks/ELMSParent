...
//		labelPictureMap.put("calendar", new ButtonOrLabelPicture("element//calendar", "element//calendar-enter", "element//calendar-clicked"));
		...
		labelPictureMap.put("close", new ButtonOrLabelPicture("element//close","element//close-enter","element//close-clicked"));
		
		labelPictureMap.put("set", new ButtonOrLabelPicture("element//set","element//set-enter","element//set-clicked"));
//		
